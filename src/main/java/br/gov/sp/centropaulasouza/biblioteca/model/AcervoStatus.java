 ...
 */
@Entity
@Table(name = "ACERVO_STATUS")
public class AcervoStatus implements Serializable {

	private static final long serialVersionUID = -341292674197127442L;
    ...
    @ManyToOne
    @ForeignKey(name = "fk_acervo_status_user_id_cadastro")
    @JoinColumn(name = "user_id_cadastro", referencedColumnName = "id")
    private Usuario usuarioCadastro;

    @ManyToOne
    @ForeignKey(name = "fk_acervo_status_user_id_alteracao")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AcervoStatus other = (AcervoStatus) obj;
		if (ativo == null) {
			if (other.ativo != null)
				return false;
