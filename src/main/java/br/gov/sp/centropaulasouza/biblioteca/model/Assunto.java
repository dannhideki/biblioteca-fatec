...
public class Assunto implements Serializable {
	...
	private static final long serialVersionUID = -4135834289790278924L;
    ...
    @ManyToOne
    @ForeignKey(name = "fk_assunto_user_id_cadastro")
    @JoinColumn(name = "user_id_cadastro", referencedColumnName = "id")
    private Usuario usuarioCadastro;

    @ManyToOne
    @ForeignKey(name = "fk_assunto_user_id_alteracao")
