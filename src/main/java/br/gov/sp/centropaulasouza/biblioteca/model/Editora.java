...
public class Editora implements Serializable{
	...
	private static final long serialVersionUID = 4096158049363943535L;
    ...
    @ManyToOne
    @ForeignKey(name = "fk_editora_user_id_cadastro")
    @JoinColumn(name = "user_id_cadastro", referencedColumnName = "id")
    private Usuario usuarioCadastro;

    @ManyToOne
    @ForeignKey(name = "fk_editora_user_id_alteracao")
