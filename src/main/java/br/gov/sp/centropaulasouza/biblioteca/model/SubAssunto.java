 ...
 */
@Entity
@Table(name = "SUB_ASSUNTO")
public class SubAssunto implements Serializable {

	private static final long serialVersionUID = -3439270519775250321L;
    ...
    @ManyToOne
    @ForeignKey(name = "fk_sub_assunto_user_id_cadastro")
    @JoinColumn(name = "user_id_cadastro", referencedColumnName = "id")
    private Usuario usuarioCadastro;

    @ManyToOne
    @ForeignKey(name = "fk_sub_assunto_user_id_alteracao")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SubAssunto other = (SubAssunto) obj;
		if (ativo == null) {
			if (other.ativo != null)
				return false;
